package com.github.charmasaur.alpsinsects.db;
...
import com.github.charmasaur.alpsinsects.model.Group;
import com.github.charmasaur.alpsinsects.model.Images;
import com.github.charmasaur.alpsinsects.model.Species;
import com.github.charmasaur.alpsinsects.provider.AssetsProvider;
...
public class FieldGuideDatabase {
  ...
  public static final String GROUPS_LICENSE = "license";
      ...
      try {
        ...
        for (int i = 0; i < groupsList.size(); ++i) {
          ...
          maybeBind(groupsStatement, groupsColumns.get(GROUPS_ICON_CREDIT),
              group.getIconCredit());
          maybeBind(groupsStatement, groupsColumns.get(GROUPS_LICENSE), group.getLicense());
